...
static void tc358768_bridge_pre_enable(struct drm_bridge *bridge)
{
	...
	case MIPI_DSI_FMT_RGB888:
		...
		sync_bclk = (mode->htotal - mode->hsync_start) * 3;
	...
	case MIPI_DSI_FMT_RGB666_PACKED:
		...
		sync_bclk = (mode->htotal - mode->hsync_start) * 18 / 8;
	...
	case MIPI_DSI_FMT_RGB565:
		...
		sync_bclk = (mode->htotal - mode->hsync_start) * 2;
	...
	/* VSDly[9:0] */
	sync_bclk = max(sync_bclk, internal_delay + 1) - internal_delay;
	tc358768_write(priv, TC358768_VSDLY, sync_bclk);
