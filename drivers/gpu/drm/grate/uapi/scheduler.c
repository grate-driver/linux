...
tegra_drm_sched_prepare_job(struct drm_sched_job *sched_job,
...
tegra_drm_sched_timedout_job(struct drm_sched_job *sched_job)
{
	struct tegra_drm_job *job = to_tegra_drm_job(sched_job);
...
const struct drm_sched_backend_ops tegra_drm_sched_ops = {
	...
	.prepare_job = tegra_drm_sched_prepare_job,
