...
static inline u32 host1x_channel_channelctrl_r(unsigned int id)
{
	return 0x98 + id * CHANNEL_IO_SIZE;
}
#define HOST1X_CHANNEL_CHANNELCTRL(id) \
	host1x_channel_channelctrl_r(id)
