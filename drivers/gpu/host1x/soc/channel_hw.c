...
#define CH_FIFOSTAT(chid) \
	(host->base_regs + HOST1X_CHANNEL_FIFOSTAT(chid))
...
#if HOST1X_HW >= 4
#define CH_CHANNELCTRL(chid) \
	(host->base_regs + HOST1X_CHANNEL_CHANNELCTRL(chid))
#endif

#define CH_CFPEEK_CTRL \
	(host->base_regs + HOST1X_SYNC_OFFSET + HOST1X_SYNC_CFPEEK_CTRL)

#define CH_CFPEEK_PTRS \
	(host->base_regs + HOST1X_SYNC_OFFSET + HOST1X_SYNC_CFPEEK_PTRS)

#define CH_CF_SETUP(chid) \
	(host->base_regs + HOST1X_SYNC_OFFSET + HOST1X_SYNC_CF_SETUP(chid))

#define CH_CFPEEK_READ \
	(host->base_regs + HOST1X_SYNC_OFFSET + HOST1X_SYNC_CFPEEK_READ)
...
#define CH_CFPEEK_CTRL \
	(host->hv_regs + HOST1X_HV_CMDFIFO_PEEK_CTRL)

#define CH_CFPEEK_PTRS \
	(host->base_regs + HOST1X_HV_CMDFIFO_PEEK_PTRS)

#define CH_CF_SETUP(chid) \
	(host->base_regs + HOST1X_HV_CMDFIFO_SETUP(chid))

#define CH_CFPEEK_READ \
	(host->base_regs + HOST1X_HV_CMDFIFO_PEEK_READ)

#define CH_ICG_EN_OVERRIDE \
	(host->base_regs + HOST1X_HV_ICG_EN_OVERRIDE)
