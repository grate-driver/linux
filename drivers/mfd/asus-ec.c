...
static int asus_ec_probe(struct i2c_client *client)
{
	...
	priv->info.hw = of_device_get_match_data(&client->dev);
...
static const struct asus_ec_hw_desc asus_pad_ec = {
	.is_pad = true,
};

static const struct asus_ec_hw_desc asus_dock_ec = {
	.is_pad = false,
};

static const struct of_device_id asus_ec_match[] = {
	{ .compatible = "asus,dock-ec", .data = &asus_dock_ec },
	{ .compatible = "asus,pad-ec", .data = &asus_pad_ec },
	{ .compatible = "asus,ec", .data = &asus_pad_ec },
	{ }
};
