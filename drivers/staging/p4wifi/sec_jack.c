...
static int __init p4wifi_jack_init(void)
{
	return platform_driver_register(&p4wifi_jack_driver);
}

static void __exit p4wifi_jack_exit(void)
{
	platform_driver_unregister(&p4wifi_jack_driver);
}

module_init(p4wifi_jack_init);
module_exit(p4wifi_jack_exit);
