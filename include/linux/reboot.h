 ...
 *		true. Can be changed by callback.
 * @mode: Reboot mode ID.
 */
struct restart_data {
	void *cb_data;
 ...
 * @cmd: Restart command string.
 * @stop_chain: Further lower priority callbacks won't be executed if set to
 *		true. Can be changed by the callback.
 ...
 *
 * @cb_data: User data included in callback's argument.
 *
 ...
 *
 * @power_off_chaining_allowed: Set to false if callbacks execution should
 * stop when @power_off_cb fails to power off this machine. True if further
 * lower priority power-off callback should be executed.
 *
 ...
 * @restart_cb is NULL.
 *
 * @restart_chaining_disallowed: Set to true if callbacks execution should
 * stop when @restart_cb fails to restart this machine. False if further
 * lower priority restart callback should be executed.
 *
 ...
 * depending on mode. It's registered with register_reboot_notifier().
...
/* These helpers disallow further chaining of power-off callbacks */
...
/* These helpers allow further chaining of restart callbacks */
 ...
 *	It will be called as a part of the restart sequence, i.e. further
 *	lower priority restart chaining is allowed.
 *
 *	Returns zero on success, or error code on failure.
 */
static inline int
